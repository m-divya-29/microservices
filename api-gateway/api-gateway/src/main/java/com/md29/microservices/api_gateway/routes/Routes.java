package com.md29.microservices.api_gateway.routes;
...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceSwaggerRoute() {
        return route("product_service_swagger")
                ...
                .filter(setPath("/api-docs")) // filter routes call to http://localhost:8080/api-docs instead of http://localhost:8080/aggregate/product-service/v3/api-docs
                .build();
    }
    @Bean
    ...
    // Fallback Route when requests fail
    @Bean
